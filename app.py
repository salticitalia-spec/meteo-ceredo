...
# --- 2. CSS CUSTOM (BLACK THEME & SNIPER TARGET) ---
st.markdown("""
<style>
...
# --- 3. DATA FETCHING (API OPEN-METEO) ---
@st.cache_data(ttl=600)
def fetch_data():
    lat, lon = 45.6117, 10.9710
    # Previsioni 12h (Modello ICON-CH/Swiss)
    ...
    # Storico 15g (Pioggia, Vento, Radiazione Solare)
...
# Grafico Storico Multi-Variabile
st.write("")
...
if hi_data and 'daily' in hi_data:
    df_hist = pd.DataFrame({
        ...
        'Vento': hi_data['daily']['Vento (km/h)']: hi_data['daily']['wind_speed_10m_max'],
