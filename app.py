...
<style>
    ...
    .aztec-wrapper {
        position: relative; width: 280px; height: 280px; margin: 20px auto; border-radius: 50%;
...
if hi and 'daily' in hi:
    ...
    fig.add_trace(go.Scatter(x=df['D'], y=df['V'], line=dict(color='#FF3311', width=2), name="Vento"))
