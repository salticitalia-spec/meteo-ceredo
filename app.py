...
<style>
    ...
    .logo-laser { width: 160px; height: 160px; margin-bottom: 5px; }
    .header-text { 
    ...
    .radar-box { position: relative; width: 100%; height: 400px; border-radius: 4px; border: 1px solid #111; overflow: hidden; margin-bottom: 20px; }
    .clock-section { display: flex; flex-direction: column; align-items: center; margin-top: 5px; }
    .digital-clock { color: #fff; font-family: 'Inter', sans-serif; font-size: 30px; font-weight: 100; }
    .countdown-text { color: #8A2BE2; font-family: 'Inter', sans-serif; font-size: 12px; letter-spacing: 4px; opacity: 0.5; margin-top: 12px; }
</style>
...
# --- 4. INTERFACCIA (CORRETTA PER EVITARE SYNTAXERROR) ---
# Usiamo doppie graffe {{ }} per l'SVG e singole { } per le variabili Python
st.markdown(f"""
<div class="header-container">
    <svg class="logo-laser" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M50 35 L50 65 M35 50 L65 50" stroke="url(#laserGrad)" stroke-width="1.2"/>
        <circle cx="50" cy="50" r="2.5" fill="url(#laserGrad)"/>
        <path d="M50 0 L50 15 M50 85 L50 100 M0 50 L15 50 M85 50 L100 50" stroke="url(#laserGrad)" stroke-width="1"/>
    </svg>
...
<div class="clock-section">
    <div class="digital-clock">{now.strftime("%H:%M")}<span style="color:#007BFF; font-size:14px; opacity:0.6;">:{now.second:02d}</span></div>
